...
import './DigitalScreensBriefForm.css';
      ...
      <div className="brief-form-container">
        <div className="brief-header">
          <div className="brief-header-content">
            <div className="brief-logo">cartology</div>
            <h1 className="brief-header-title">Digital Screens Content Brief</h1>
            <p className="brief-header-subtitle">Please complete and return to: screencontent@cartology.com.au</p>
          </div>
        </div>

        <div className="brief-form-content">
          {taskId && (
            <Text UNSAFE_className="brief-description" style={{ marginBottom: '20px' }}>
              Task ID: {taskId}
            </Text>
          )}

          {isSuccess ? (
            <Well variant="positive" marginBottom="size-200">
            ...
            <Form>
              <div className="brief-section">
                <h2 className="brief-section-title">Prefilled Workfront Data</h2>
                <div className="brief-field-row">
                  <div className="brief-field-half">
                    <TextField
                      label="Booking ID"
              ...
              <div className="brief-section">
                <h2 className="brief-section-title">General Information</h2>
                <Text className="brief-description">
                  Please complete and return to: screencontent@cartology.com.au
                </Text>
                <Text className="brief-description" marginTop="size-100">
                  <a
                    href="https://author-p121280-e1429483.adobeaemcloud.com/linksharepreview.html/content/dam/uploadpoc/IN-AISLE.pdf?sh=8216c2ff_f20f_4a9a_8a96_e2703f77809f.MCPIxZOeZLcIbD7OpFLAmuPd_g56cpBD9W_L0ocB4aA"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{ color: '#0d66d0', textDecoration: 'underline' }}
                  >
                    Open IN-AISLE PDF
                  </a>
                </Text>
              ...
              <div className="brief-section">
                <h2 className="brief-section-title">Product / Promotional Details</h2>
                <div className="brief-field-row">
                  <div className="brief-field-half">
                    <TextField
              ...
              <div className="brief-section">
                <h2 className="brief-section-title">Product Claims</h2>
                <Text className="brief-description">
              ...
              <div className="brief-section">
                <h2 className="brief-section-title">Third Party References</h2>
                <Text className="brief-description">
              ...
              <div className="brief-section">
                <h2 className="brief-section-title">Therapeutic Goods</h2>
                <Text className="brief-description">
              ...
              <div className="brief-section">
                <h2 className="brief-section-title">On Screen Disclaimers</h2>
                <Text className="brief-description">
              ...
              <div className="brief-section">
                <h2 className="brief-section-title">Acknowledgement</h2>
                <Well>
                  <Text className="brief-description" style={{ display: 'block', marginBottom: '12px' }}>
